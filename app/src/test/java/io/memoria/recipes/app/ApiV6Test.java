...
class ApiV6Test {
  ...
  public ApiV6Test() throws ResolutionException, ValidationException {
  ...
  void schema() throws Exception {
    OpenAPITestUtils.validateSchema(api, "model/recipe/RecipeDtoV6.json", RecipeDto.class.getSimpleName());
  }
}
